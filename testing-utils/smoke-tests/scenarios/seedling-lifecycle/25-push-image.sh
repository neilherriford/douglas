...
#
# The hello-world build context is on the VM at $EXAMPLE_SEEDLINGS/hello-world;
# ci-fanout.sh copies the repo's example-seedlings/ there before any scenario runs.
set -uo pipefail
